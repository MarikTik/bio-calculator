...
def create_carrier_to_codon_map(genes_dictionary: Dict[str, str]) -> Dict[str, Dict[Codon, int]]:
     """Count occurrences of codons for each carrier."""
     return{
          carrier : Codon.codons_count_map(gene) for carrier, gene in genes_dictionary.items()
     }